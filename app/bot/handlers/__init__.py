...
def register_handlers(application: Application) -> None:
    ...
    application.add_handler(MessageHandler(filters.TEXT & filters.Regex(r"^نمایشگاه ماشین حاج ممد$"), vehicle.text))
    application.add_handler(CallbackQueryHandler(vehicle.callback, pattern=r"^cars:(?:catalog|mine|buy:[a-z0-9_]+|confirm:[a-z0-9_]+)$"))
